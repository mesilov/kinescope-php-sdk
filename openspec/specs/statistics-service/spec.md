...
## Purpose
Defines the SDK statistics service, its factory wiring, statistics DTO shape, account/project/folder aggregation behavior, pagination behavior, and API error propagation.
