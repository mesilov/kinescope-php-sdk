# paginated-response-meta Specification

## Purpose
Defines how SDK paginated list responses parse Kinescope `meta.pagination` payloads, reject malformed pagination metadata, and calculate page navigation when `last_page` is absent.
