# kinescope-cli Specification

## Purpose
Define the public SDK CLI executable, command naming, credential handling, identifier validation, read-only resource commands, output formats, and sanitized asset output for the resource/action command surface.
