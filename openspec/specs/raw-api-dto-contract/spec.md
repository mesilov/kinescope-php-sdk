# raw-api-dto-contract Specification

## Purpose
Define the SDK-wide DTO contract for mirroring current Kinescope raw API field names, preserving raw-shaped array exports, using immutable date objects, and handling unpaginated data responses.
